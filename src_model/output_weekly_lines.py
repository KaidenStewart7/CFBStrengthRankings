...
def create_weekly_html():
    ...
    with open(
        ...
        file.write(
            ...
            "The team's ranking for the week can be found in red next to the team name.\n"
        )
...
def create_lines_index():
    ...
    with open(
        ...
        file.write(
            ...
            "generated by the model. Important note: Only FBS vs FBS games will have lines for them.<br><br>\n"
        )

        file.write(
            "            Based on test data using 2025 lines and results, in 2025 our model would've had a 83.95% succsess rate of picking the winner (Vegas sits around 75%) and our model would've had a mean absoulte error of 10.65 points (Vegas sits a little over 12 points).<br><br>\n"
        )

        file.write(
            "            <strong>DISCLAIMER: THESE LINES ARE FOR "
            "ENTERTAINMENT AND ANALYTICAL PURPOSES ONLY. "
            "THEY ARE NOT INTENDED FOR BETTING OR GAMBLING "
            "PURPOSES.</strong><br><br>\n"
        )

        file.write(
            "            The projected lines on this website are "
            "generated using statistical models and college "
            "football strength ratings. They are not official "
            "betting lines, gambling advice, or recommendations "
            "to wager money. The projections are inherently "
            "uncertain and should not be used to make financial "
            "or betting decisions.<br><br>\n"
        )

        file.write(
            "            <strong>Do not use these lines for betting "
            "purposes.</strong> They are intended solely for "
            "comparing teams, evaluating our ratings, and enjoying "
            "college football.\n"
        )
